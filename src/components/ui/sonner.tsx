  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast items-start gap-3 overflow-hidden rounded-[1.5rem] border border-border/60 bg-[linear-gradient(180deg,hsl(var(--background)/0.86),hsl(var(--background)/0.80))] p-4 pr-12 text-foreground shadow-[inset_0_1px_0_hsl(var(--accent)/0.3),0_18px_50px_hsl(var(--background)/0.45)] glass-tier-chrome backdrop-saturate-150 transition-[border-color,box-shadow,background-color] duration-300",
          ...
          icon: "mt-0.5 flex h-10 w-10 items-center justify-center rounded-2xl border border-white/15 bg-white/70 text-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.35)] glass-tier-surface dark:border-white/10 dark:bg-white/[0.06]",
          closeButton:
          ...
          actionButton:
            "h-9 rounded-full border border-primary/20 bg-primary px-4 text-[12px] font-semibold text-primary-foreground shadow-[0_10px_24px_hsl(var(--accent)/0.14)] transition-all hover:shadow-[0_14px_30px_hsl(var(--accent)/0.2)]",
          cancelButton:
          ...
          success:
            "border-primary/25 shadow-[inset_0_1px_0_hsl(var(--accent)/0.42),0_18px_50px_hsl(var(--accent)/0.18)] [&_[data-icon]]:border-primary/20 [&_[data-icon]]:bg-primary/10 [&_[data-icon]]:text-primary",
          error:
          ...
          loading:
            "border-primary/20 shadow-[inset_0_1px_0_hsl(var(--accent)/0.38),0_18px_50px_hsl(var(--accent)/0.14)] [&_[data-icon]]:border-primary/20 [&_[data-icon]]:bg-primary/10 [&_[data-icon]]:text-primary",
        },
      }}
      {...props}
    />
